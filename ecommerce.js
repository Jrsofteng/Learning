...
function addToCart(itemID,quantity ){
    ...
    function displayCart(){
        for (const item of Cart){
            console.log("our product name is at  " + item.productname + " and the price is " + item.productPrice)
        }
    }
    displayCart()
    // using the reduce function to get the total of the prices of items
